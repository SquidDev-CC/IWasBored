...
import org.squiddev.iwasbored.core.impl.provider.LuaObjectCollection;
...
import org.squiddev.iwasbored.gameplay.api.neural.INeuralUpgrade;
...
public class NeuralInterface extends ServerComputerManager implements INeuralInterface, ILuaAPI {
	...
	public NeuralInterface(EntityPlayer player, int instanceId, int sessionId, NBTTagCompound tagCompound) {
		...
		apiMethods = new LuaObjectCollection(IWasBoredGameplayAPI.instance().neuralRegistry().getLua(this));
	}
